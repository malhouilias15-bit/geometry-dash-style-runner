...
/* ---------- SHOP ---------- */
document.getElementById("start10").onclick = () => buyBoost(10, 20);
document.getElementById("start20").onclick = () => buyBoost(20, 40);
document.getElementById("secondChance").onclick = () => buySecondChance();
document.getElementById("spikeShield").onclick = () => buySpikeShield();
document.getElementById("earlySkin").onclick = () => buyEarlySkin();
...
function update() {
  ...
  if (spikeShield) {
    spikeShieldTimer--;
    if (spikeShieldTimer <= 0) spikeShield = false;
  }
...
function draw() {
  ...
  if (spikeShield) ctx.shadowColor = "cyan";
  ctx.beginPath();
