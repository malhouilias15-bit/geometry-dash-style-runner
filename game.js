...
function spawnHard() {
  ...
  // 2 orbs
  orbs.push({ x: x - 40, y: canvas.height - groundH - 120 });
  orbs.push({ x: x - 10, y: canvas.height - groundH - 160 });

  // safe blocks
  platforms.push({ x: x + 10, y: canvas.height - groundH - 190, w: 50, h: 10 });
  platforms.push({ x: x + 70, y: canvas.height - groundH - 220, w: 50, h: 10 });
